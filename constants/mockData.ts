...
export const FAQ = [
  {
    title: 'What is 1ClickSUIDefi and How Does It Work ???',
    content: `1ClickSUIDefi is a one-stop place for users to build their own custom DeFi strategies on the Sui ecosystem. By integrating protocols like lending, DEX, and LST, we simplify complex and tedious operations, allowing users to effortlessly enhance their capital efficiency and potentially increase their returns.`,
    contentHeight: 'h-27 xl:h-22',
  },
  {
    title: 'What is a Vault?',
    content: `Each Vault represents a series of specific on-chain operations. Users can find a suitable Vault based on their risk preference, yield, and protocol attributes. 1ClickSUIDefi simplifies complex on-chain operations using PTB's, which can include multiple deposits, borrow, and swap operations within the same transaction block. From the user's perspective, this offers an experience where no additional funds are needed, nor is there a need to worry about parameter settings to achieve the desired outcome.`,
