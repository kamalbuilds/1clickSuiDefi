...
const pools: { [key: string]: Pool } = {
  ...
  "USDCbnb-SUI": {
    objectId:
      "0x517ee525c34fdfb2240342bd43fc07e1ec253c2442a7edd2482e6973700c6ef5",
    tokenXType: "USDCbnb",
    tokenYType: "SUI",
  },
  "CUSDCe-CUSDTe": {
    objectId:
      "0x1a32f76a27f49ba590ffebfd906bd4d6733e67090c5aec9bdd50d2c34e5db763",
    tokenXType: "cUSDCe",
    tokenYType: "cUSDTe",
  },
  "CUSDCe-SUI": {
    objectId:
      "0x074c421ceea5db8c393d4b5520d612782ccf10b51856d844d998a3fbc4896170",
    tokenXType: "cUSDCe",
    tokenYType: "SUI",
  },
  "BUCK-SUI": {
...
export declare function getFullnodeUrl(
...
export const ACTIONS: { [key in keyof typeof ActionTypes]?: any } = {
  ...
  [ActionTypes.REMOVE_LIQUIDITY]: {
    ...
    availableProtocols: [ProtocolNames.NAVI, ProtocolNames.KRIYADEX],
  },
  [ActionTypes.TakeFlashLoan]: {
    type: ActionTypes.TakeFlashLoan,
    name: "Take Flashloan",
    availableProtocols: [ProtocolNames.NAVI, ProtocolNames.BUCKET],
  },
...
export const SELECTABLE_TOKENS = [
  ...
  },
  {
    ...
    symbol: "WETH",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/common/WETH.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "CETUS",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b_cetus_CETUS.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "MOVE",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/0xd9f9b0b4f35276eecd1eea6985bfabe2a2bbd5575f9adb9162ccbdb4ddebde7f_smove_SMOVE.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "SSWP",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc_TOKEN_TOKEN.png",
    extensions: {
      coingeckoId: "suiswap",
    },
  },
  ...
  },
  {
    ...
    symbol: "BUCK",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/bucket-usd.png",
  },
  {
    ...
    symbol: "SCB",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/sacabam.png",
  },
  {
    ...
    symbol: "SUIP",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/suip.png",
    extensions: {
      coingeckoId: "suipad",
    },
  },
  {
    ...
    symbol: "REAP",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/reap.png",
    extensions: {
      coingeckoId: "releap",
    },
  },
  {
    ...
    symbol: "vSUI",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/vsui.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "afSUI",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/afsui.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "haSUI",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/hasui.png",
  },
  {
    ...
    symbol: "SBOX",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/sbox.png",
  },
  {
    ...
    symbol: "BURRY",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/burry.png",
  },
  {
    ...
    symbol: "IUS",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/ius.png",
  },
  {
    ...
    symbol: "BABYSCB",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/babyscb.png",
  },
  {
    ...
    symbol: "DSUI",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/dsui.png",
  },
  {
    ...
    symbol: "FLX",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/flx.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "XFLX",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/xflx.png",
  },
  {
    ...
    symbol: "SUIPEPE",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/suipepe.png",
  },
  {
    ...
    symbol: "SRC",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/src.png",
  },
  {
    ...
    symbol: "VAPOREON",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/vaporeon.png",
  },
  {
    ...
    symbol: "HOLD",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/hold.png",
  },
  {
    ...
    symbol: "NAVX",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/navx.png",
    extensions: {
      coingeckoId: "navi",
    },
  },
  {
    ...
    symbol: "SPT",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/spt.png",
    extensions: {
      coingeckoId: "seapad",
    },
  },
  {
    ...
    symbol: "FUD",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/fud.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "SCA",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/sca.png",
    extensions: {
  ...
  },
  {
    ...
    symbol: "HSUI",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/suicune.png",
  },
  {
    ...
    symbol: "ALP",
    logoURI:
      "https://raw.githubusercontent.com/sonarwatch/token-lists/main/images/sui/alp.webp",
  },
];
