...
const FoldedPanel = ({
  ...
  return (
    <div
      ...
      onClick={setIsFolded}
    >
      <div className="text-white text-base xl:text-xl font-medium self-stretch max-md:max-w-full mb-4 xl:mb-5">
        {title}
      </div>
      <div
        className={cn(
          "text-black text-xs xl:text-base self-stretch max-md:max-w-full ease-in-out duration-300",
